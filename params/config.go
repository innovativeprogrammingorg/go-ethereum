...
var (
	...
	MainnetChainConfig = &ChainConfig{
		...
		WhiteblockBlock: 	 big.NewInt(8090007),
...
func (c *ChainConfig) String() string {
	...
	return fmt.Sprintf("{ChainID: %v Homestead: %v DAO: %v DAOSupport: %v EIP150: %v EIP155: %v EIP158: %v Byzantium: %v Constantinople: %v  ConstantinopleFix: WB: %v WB Revert: %v Engine: %v}",
		c.ChainID,
		c.HomesteadBlock,
		c.DAOForkBlock,
		c.DAOForkSupport,
...
func (c *ChainConfig) IsWhiteblock(num *big.Int) bool {
	return isForked(c.WhiteblockBlock, num)
}
